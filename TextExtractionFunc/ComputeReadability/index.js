...
function splitSentences(text, context) {
  ...
  try {
    ...
    context.log(
      `Unable to parse with SentenceTokenizerNew because of ${error}`
    );
...
module.exports = async function (context, request) {
  ...
  var lexiconCount = Readability.lexiconCount(
    content,
  ...
  var automatedReadabilityIndex =
    Readability.automatedReadabilityIndex(content);
  var daleChallReadabilityScore =
    Readability.daleChallReadabilityScore(content);
