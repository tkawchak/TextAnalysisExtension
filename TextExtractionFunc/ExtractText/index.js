...
async function getParsedText(parsedInput, context) {
  ...
  try {
    ...
    // Returns 'text' content type after parsing the html
    // User agent specified to
    parsedTextResult = await Parser.parse(url, {
      contentType: "text",
...
module.exports = async function (context, request) {
  ...
  var responseBody = {
    ...
    date_published:
      parsedTextResult.date_published || new Date(Date.UTC(0)).toJSON(),
